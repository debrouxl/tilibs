...
/**
 * ticonv_model_is_ti83p_family:
 * @model: a calculator model taken in #CalcModel.
 *
 * Returns whether the given calculator model is considered a member of the TI-83+ family.
 *
 * Return value: nonzero if the calculator is a TI-83+-like calculator, zero if it doesn't.
 */

...
public:
	...
	STDMETHOD(CableGet)(/*[in]*/ long handle, /*[out]*/ unsigned char *data);
	STDMETHOD(CablePut)(/*[in]*/ long handle, /*[in]*/ unsigned char data);
	STDMETHOD(ProgressGet)(/*[in]*/ long handle, /*[out]*/ long *count, /*[out]*/ long *msec, /*[out]*/ float *rate);
	STDMETHOD(ProgressReset)(/*[in]*/ long handle);
	...
	STDMETHOD(CableCheck)(/*[in]*/ long handle, /*[out]*/ short *status);
	STDMETHOD(CableRecv)(/*[in]*/ long handle, /*[out]*/ SAFEARRAY __RPC_FAR * __RPC_FAR *data, /*[in]*/ long count);
	STDMETHOD(CableSend)(/*[in]*/ long handle, /*[in]*/ SAFEARRAY __RPC_FAR * data, /*[in]*/ long count);
	STDMETHOD(CableProbe)(/*[in]*/ long handle, /*[out, retval]*/ BOOL *result);
	STDMETHOD(CableReset)(/*[in]*/ long handle);
	STDMETHOD(CableClose)(/*[in]*/ long handle);
	STDMETHOD(CableOpen)(/*[in]*/ long handle);

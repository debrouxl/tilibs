...
void tiopers_debug (const gchar *format, ...)
{
  va_list args;
...
void tiopers_info (const gchar *format, ...)
{
  va_list args;
  va_start (args, format);
...
void tiopers_message (const gchar *format, ...)
{
  va_list args;
  va_start (args, format);
...
void tiopers_warning (const gchar *format, ...)
{
  va_list args;
  va_start (args, format);
...
void tiopers_critical (const gchar *format, ...)
{
  va_list args;
  va_start (args, format);
...
void tiopers_error (const gchar *format, ...)
{
  va_list args;
  va_start (args, format);

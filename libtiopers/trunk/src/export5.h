...
#ifndef __TIOPERS_EXPORT__
#define __TIOPERS_EXPORT__
...
# define TIEXPORT5 __attribute__ ((visibility("default")))
...
#  if defined(TIOPERS_EXPORTS)
#   define TIEXPORT5 __declspec(dllexport)
#  else
#   define TIEXPORT5 __declspec(dllimport)
#  endif

# elif defined(__MINGW32__)		// MinGW - GCC for Windows, (c) 2002 Kevin Kofler
#  if defined(TIOPERS_EXPORTS)	// defined by the configure script
#   define TIEXPORT5 __declspec(dllexport)
#  else
#   define TIEXPORT5 __declspec(dllimport)
#  endif

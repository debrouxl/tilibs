...
#define NULL_ENTRY \
	...
	DEFINE_MENU_ENTRY("DBUS 83+ Memory dump", ti83p_dump),                                     // 65
	NULL_ENTRY,
	...
	NULL_ENTRY,
	DEFINE_MENU_ENTRY("DBUS 83+ Get standard calculator ID", ti83p_gid),                       // 70
	...
	NULL_ENTRY,
	DEFINE_MENU_ENTRY("NSP  Send key (specific and generic)", nsp_send_key),                   // 75
	NULL_ENTRY,

...
TIEXPORT3 int TICALL tiz80_send_RTS_lab_equipment_data(CalcHandle* handle, uint16_t varsize, uint8_t target, const char * varname);
TIEXPORT3 int TICALL ti73_send_RTS_lab_equipment_data(CalcHandle* handle, uint16_t varsize, uint8_t target, const char * varname);
TIEXPORT3 int TICALL ti8283_send_RTS_lab_equipment_data(CalcHandle* handle, uint16_t varsize, uint8_t target, const char * varname);
TIEXPORT3 int TICALL ti8586_send_RTS_lab_equipment_data(CalcHandle* handle, uint16_t varsize, uint8_t target, const char * varname);
TIEXPORT3 int TICALL ti73_send_REQ_lab_equipment_data(CalcHandle* handle, uint8_t target, const char * varname);
TIEXPORT3 int TICALL ti8283_send_REQ_lab_equipment_data(CalcHandle* handle, uint8_t target, const char * varname);
TIEXPORT3 int TICALL ti8586_send_REQ_lab_equipment_data(CalcHandle* handle, uint8_t target, const char * varname);

...
TIEXPORT3 uint8_t TICALL tiz80_model_to_dbus_mid(CalcModel model)
{
	...
	{
	case CALC_TI73:
		retval = DBUS_MID_PC_TI73;
	case CALC_TI82:
		retval = DBUS_MID_PC_TI82;
	case CALC_TI83:
		retval = DBUS_MID_PC_TI83;
	case CALC_TI83P:
	case CALC_TI84P:
	case CALC_TI84PC:
		retval = DBUS_MID_PC_TI83p;
	case CALC_TI85:
		retval = DBUS_MID_PC_TI85;
	case CALC_TI86:
		retval = DBUS_MID_PC_TI86;
	default:
		retval = DBUS_MID_PC_TIXX;
	}

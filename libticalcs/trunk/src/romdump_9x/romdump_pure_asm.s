...
| Size bytes (skipped here because we use `tifileutil wrap` afterwards)
|	.byte (((__end_of_program_data - __beginning_of_program_data) >> 8) & 0xFF)
|	.byte ((__end_of_program_data - __beginning_of_program_data) & 0xFF)
...
.endif
__str_ROMbase:
	.asciz "ROM base: 0x%lx"
__str_Credits:
	.asciz "by The TILP Team"
__str_Size:
	.asciz "Size: %lu KB"
__str_Done:
	.asciz "Done: %lu/%luKB     "
...
|	.byte 0xF3 | ASM_TAG (skipped here because we use `tifileutil wrap` afterwards)
__end_of_program_data:

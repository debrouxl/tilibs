...
TIEXPORT3 int TICALL rd_dump(CalcHandle* handle, const char *filename);
TIEXPORT3 int TICALL rd_is_ready(CalcHandle* handle);
TIEXPORT3 int TICALL rd_send(CalcHandle *handle, const char *prgname, uint16_t size, uint8_t *data);

...
#define KEY73_Seqential            0xfe5f
#define KEY73_SimulG               0xfe60
#define KEY73_CoordOn              0xfe61
#define KEY73_CoordOff             0xfe62
#define KEY73_DrawLine             0xfe63
#define KEY73_DrawDot              0xfe64
#define KEY73_AxisOn               0xfe65
#define KEY73_AxisOff              0xfe66
#define KEY73_GridOn               0xfe67
#define KEY73_GridOff              0xfe68
#define KEY73_LblOn                0xfe69
#define KEY73_OblOff               0xfe6a
#define KEY73_PolarG               0xfe6b
#define KEY73_RectG                0xfe6c

#define KEY73_L1                   0xfe6d
#define KEY73_L2                   0xfe6e
#define KEY73_L3                   0xfe6f
#define KEY73_L4                   0xfe70
#define KEY73_L5                   0xfe71
#define KEY73_L6                   0xfe72

#define KEY73_MatA                 0xfe73
#define KEY73_MatB                 0xfe74
#define KEY73_MatC                 0xfe75
#define KEY73_MatD                 0xfe76
#define KEY73_MatE                 0xfe77

#define KEY73_Xmin                 0xfe78
#define KEY73_Xmax                 0xfe79
#define KEY73_Xscl                 0xfe7a
#define KEY73_Ymin                 0xfe7b
#define KEY73_Ymax                 0xfe7c
#define KEY73_Yscl                 0xfe7d
#define KEY73_Tmin                 0xfe7e
#define KEY73_Tmax                 0xfe7f
#define KEY73_TStep                0xfe80
#define KEY73_Omin                 0xfe81
#define KEY73_Omax                 0xfe82
#define KEY73_OStep                0xfe83
#define KEY73_u0                   0xfe84
#define KEY73_v0                   0xfe85
#define KEY73_nMin                 0xfe86
#define KEY73_nMax                 0xfe87
#define KEY73_DeltaY               0xfe88
#define KEY73_DeltaX               0xfe89

#define KEY73_ZXmin                0xfe8a
#define KEY73_ZXmax                0xfe8b
#define KEY73_ZXscl                0xfe8c
#define KEY73_ZYmin                0xfe8d
#define KEY73_ZYmax                0xfe8e
#define KEY73_ZYscl                0xfe8f
#define KEY73_ZTmin                0xfe90
#define KEY73_ZTmax                0xfe91
#define KEY73_ZTStep               0xfe92
#define KEY73_ZOmin                0xfe93
#define KEY73_ZOmax                0xfe94
#define KEY73_ZOStep               0xfe95

#define KEY73_ABC                  0xfe96
#define KEY73_BC                   0xfe97
#define KEY73_AutoSimp             0xfe98
#define KEY73_ManSimp              0xfe99

#define KEY73_DelLast              0xfe9a
#define KEY73_singleC              0xfe9b
#define KEY73_MultiC               0xfe9c

#define KEY73_Pic1                 0xfe9d
#define KEY73_Pic2                 0xfe9e
#define KEY73_Pic3                 0xfe9f

#define KEY73_DelVar               0xfea0
#define KEY73_GetCalc              0xfea1

#define KEY73_Stndrd               0xfea2
#define KEY73_Param                0xfea3
#define KEY73_Polar                0xfea4
#define KEY73_AFillOn              0xfea5
#define KEY73_AFillOff             0xfea6
#define KEY73_ACalcOn              0xfea7
#define KEY73_ACalcOff             0xfea8

#define KEY73_SetConst             0xfea9

#define KEY73_GraphStyle           0xfeaa

#define KEY73_ExprOn               0xfeab
#define KEY73_ExprOff              0xfeac
#define KEY73_StatA                0xfead
#define KEY73_StatB                0xfeae
#define KEY73_StatC                0xfeaf
#define KEY73_Corr                 0xfeb0
#define KEY73_StatD                0xfeb1
#define KEY73_StatE                0xfeb2
#define KEY73_RegEq                0xfeb3
#define KEY73_MinX                 0xfeb4
#define KEY73_Q1                   0xfeb5
#define KEY73_MD                   0xfeb6
#define KEY73_Q3                   0xfeb7
#define KEY73_MaxX                 0xfeb8
#define KEY73_StatX1               0xfeb9
#define KEY73_StatY1               0xfeba
#define KEY73_StatX2               0xfebb
#define KEY73_StatY2               0xfebc
#define KEY73_StatX3               0xfebd
#define KEY73_StatY3               0xfebe
#define KEY73_TblMin               0xfebf
#define KEY73_TblStep              0xfec0
#define KEY73_SetupLst             0xfec1
#define KEY73_ClrAllLst            0xfec2
#define KEY73_Logistic             0xfec3
#define KEY73_c1                   0xfec4
#define KEY73_c2                   0xfec5
#define KEY73_c3                   0xfec6
#define KEY73_c4                   0xfec7
#define KEY73_PlotStart            0xfec8
#define KEY73_ZPlotStart           0xfec9
#define KEY73_XFact                0xfeca
#define KEY73_YFact                0xfecb
#define KEY73_MaxY                 0xfecc
#define KEY73_TblInput             0xfecd
#define KEY73_PlotStep             0xfece
#define KEY73_ZPlotStep            0xfecf
#define KEY73_SelectA              0xfed0
#define KEY73_ZFitA                0xfed1
#define KEY73_OneVar               0xfed2
#define KEY73_TwoVar               0xfed3
#define KEY73_LR                   0xfed4
#define KEY73_LRExp                0xfed5
#define KEY73_LRLn                 0xfed6


#define KEY73_MedMed               0xfed7
#define KEY73_Quad                 0xfed8
#define KEY73_ClrLst               0xfed9
#define KEY73_Hist                 0xfeda
#define KEY73_XYLine               0xfedb
#define KEY73_Scatter              0xfedc
#define KEY73_LR1                  0xfedd
#define KEY73_ClrTbl               0xfede

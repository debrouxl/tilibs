...
#define DUSB_DH_SIZE		(4U+2U)	// size + type

// Virtual packet types

#define DUSB_VPKT_PING		0x0001U
#define DUSB_VPKT_OS_BEGIN	0x0002U
#define DUSB_VPKT_OS_ACK	0x0003U
#define DUSB_VPKT_OS_HEADER	0x0004U
#define DUSB_VPKT_OS_DATA	0x0005U
#define DUSB_VPKT_EOT_ACK	0x0006U
#define DUSB_VPKT_PARM_REQ	0x0007U
#define DUSB_VPKT_PARM_DATA	0x0008U
#define DUSB_VPKT_DIR_REQ	0x0009U
#define DUSB_VPKT_VAR_HDR	0x000AU
#define DUSB_VPKT_RTS		0x000BU
#define DUSB_VPKT_VAR_REQ	0x000CU
#define DUSB_VPKT_VAR_CNTS	0x000DU
#define DUSB_VPKT_PARM_SET	0x000EU
#define DUSB_VPKT_MODIF_VAR	0x0010U
#define DUSB_VPKT_EXECUTE	0x0011U
#define DUSB_VPKT_MODE_SET	0x0012U

#define DUSB_VPKT_DATA_ACK	0xAA00U
#define DUSB_VPKT_DELAY_ACK	0xBB00U
#define DUSB_VPKT_EOT		0xDD00U
#define DUSB_VPKT_ERROR		0xEE00U

...
static inline const char *ti86_byte2type(uint8_t data)
{
	//if(data >= TI86_MAXTYPES) tifiles_warning(_("ti86_byte2type: unknown type (%02x)."), data);
...
static inline const char *ti86_byte2fext(uint8_t data)
{
	//if(data >= TI86_MAXTYPES) tifiles_warning(_("ti86_byte2fext: unknown type (%02x)."), data);
...
static inline const char *ti86_byte2icon(uint8_t data)
{
	//if(data >= TI86_MAXTYPES) tifiles_warning(_("ti86_byte2icon: unknown type (%02x)."), data);
